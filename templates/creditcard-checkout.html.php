    ...
    <?php if(!empty($user_payment_profile)): ?>
        <div class="vindi-old-cc-data">
            <p class="form-row">
                ...
                <div class="vindi-cc-img" style="background: url('https://s3.amazonaws.com/recurrent/payment_companies/<?php echo $user_payment_profile['payment_company']?>.png') no-repeat center right; background-size: auto 90%;">
